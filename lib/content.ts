export const site = {
  ...
  description:
    "Permit-ready residential and commercial plans with dependable guidance from concept to approval.",
  phone: "+1 (714) 767-7457",
  email: "joelmrqz70@gmail.com",
  location: "Coarsegold, California",
  hours: "Mon–Fri · 8:00–5:00 PT",
  established: 1995,
  coordinates: "37.2614° N, 119.7012° W",
};
...
export const stats = [
  ...
  { value: "EN · ES", label: "Bilingual studio" },
];
...
export const projects: Project[] = [
  {
    code: "A-01",
    title: "Red Lion Drive Remodel",
    type: "Remodel & Addition",
    scope: "3 bed · 3 bath",
    area: "1,811 + 263 sq ft",
    jurisdiction: "Fresno County",
    year: "2026",
    status: "Permit Approved",
    plan: 2,
    note: "A 263-square-foot addition and full remodel of a two-story single-family residence built in 1988, drawn into the existing footprint.",
  },
  {
    code: "A-02",
    title: "Arroyo Seco Avenue ADUs",
    type: "ADU Conversion",
    scope: "Garage + 2nd-floor ADU",
    area: "408 + 1,055 sq ft",
    jurisdiction: "Los Angeles",
    year: "2026",
    status: "Permit Approved",
    plan: 6,
    note: "Two accessory dwelling units on a 1908 multi-family lot — a 408 sq ft garage conversion and a 1,055 sq ft second-floor unit — drawn to California's ADU state code, with the main residence remodeled.",
  },
  {
    code: "A-03",
    title: "West 53rd Street ADUs",
    type: "ADU Conversion",
    scope: "Garage + 2nd-floor ADU",
    area: "744 + 640 sq ft",
    jurisdiction: "Los Angeles",
    ...
    status: "Permit Approved",
    plan: 3,
    note: "A garage converted to a 744 sq ft ADU plus a new 640 sq ft second-floor accessory unit on a 1913 lot, both drawn to the state ADU code.",
  },
];
...
export const trustPoints = [
  {
    ...
    body: "Three decades of submittals across Los Angeles, Orange, and Fresno-area building departments — we know how each one reads a set.",
  },
  {
